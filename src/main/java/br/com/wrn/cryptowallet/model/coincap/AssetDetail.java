...
public class AssetDetail implements Serializable {
    ...
    public AssetDetail(
            String id, String rank, String symbol, String name,
            String supply, String maxSupply, String marketCapUsd,
            String volumeUsd24Hr, String priceUsd, String changePercent24Hr,
